                ...
                <div className="space-y-6">
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        <div className="grid gap-2">
                            <FormLabel htmlFor="salary_category_id" required>
                                Salary Expense Category
                            </FormLabel>

                            <select
                                id="salary_category_id"
                                className="border-input bg-background ring-offset-background placeholder:text-muted-foreground focus-visible:ring-ring flex h-12 w-full rounded-md border px-3 py-2 text-sm text-neutral-900 file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 md:h-10 dark:text-neutral-100"
                        ...
                        <div className="grid gap-2">
                            <FormLabel htmlFor="material_expense_category_id" required>
                        ...
                        <div className="grid gap-2">
                            <FormLabel htmlFor="business_transportation_category_id" required>
                                Business Transportation Expense Category
                            </FormLabel>
                        ...
                        <div className="grid gap-2">
                            <FormLabel htmlFor="delivery_transportation_category_id" required>
                                Delivery Transportation Expense Category
                            </FormLabel>
